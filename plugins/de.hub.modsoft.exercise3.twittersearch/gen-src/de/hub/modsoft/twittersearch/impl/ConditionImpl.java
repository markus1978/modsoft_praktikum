 ...
 * </p>
 * <ul>
 *   <li>{@link de.hub.modsoft.twittersearch.impl.ConditionImpl#getField <em>Field</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ConditionImpl extends MinimalEObjectImpl.Container implements Condition {
	 ...
	 * @ordered
	 */
	protected static final Fields FIELD_EDEFAULT = Fields.FAVORITS;
	 ...
	 * @ordered
	 */
	protected Fields field = FIELD_EDEFAULT;
	 ...
	 * @generated
	 */
	public void setField(Fields newField) {
		Fields oldField = field;
		field = newField == null ? FIELD_EDEFAULT : newField;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TwitterSearchPackage.CONDITION__FIELD, oldField, field));
	}
