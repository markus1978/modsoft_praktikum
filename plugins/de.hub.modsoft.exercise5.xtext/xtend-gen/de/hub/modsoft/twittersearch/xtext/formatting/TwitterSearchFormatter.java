 ...
 * generated by Xtext
 */
package de.hub.modsoft.twittersearch.xtext.formatting;
...
public class TwitterSearchFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private TwitterSearchGrammarAccess _twitterSearchGrammarAccess;
  
  @Override
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword, Keyword>> _findKeywordPairs = this._twitterSearchGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._twitterSearchGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._twitterSearchGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._twitterSearchGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._twitterSearchGrammarAccess.getML_COMMENTRule();
