...
(
    ...
    { 
        $current = $this_StringCondition_0.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_IntCondition_1.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_BooleanCondition_2.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
ruleStringOperators returns [Enumerator current=null] 
    @init { enterRule(); }
    @after { leaveRule(); }:
