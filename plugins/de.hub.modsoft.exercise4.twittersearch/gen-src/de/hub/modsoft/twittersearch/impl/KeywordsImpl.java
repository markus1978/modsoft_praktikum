 ...
 * </p>
 * <ul>
 *   <li>{@link de.hub.modsoft.twittersearch.impl.KeywordsImpl#getKeywords <em>Keywords</em>}</li>
 * </ul>
 *
 * @generated
 */
public class KeywordsImpl extends SearchOptionImpl implements Keywords {
	/**
	...
	protected EClass eStaticClass() {
		return TwitterSearchPackage.Literals.KEYWORDS;
	}
	...
	public EList<String> getKeywords() {
		if (keywords == null) {
			keywords = new EDataTypeUniqueEList<String>(String.class, this, TwitterSearchPackage.KEYWORDS__KEYWORDS);
		}
		return keywords;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TwitterSearchPackage.KEYWORDS__KEYWORDS:
				return getKeywords();
		}
