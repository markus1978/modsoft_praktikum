 ...
 * </p>
 * <ul>
 *   <li>{@link de.hub.modsoft.twittersearch.impl.TwitterObjectTypeDeclarationImpl#getFields <em>Fields</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TwitterObjectTypeDeclarationImpl extends TypeImpl implements TwitterObjectTypeDeclaration {
	/**
	...
	public EList<TwitterFieldDeclaration> getFields() {
		if (fields == null) {
			fields = new EObjectContainmentEList<TwitterFieldDeclaration>(TwitterFieldDeclaration.class, this, TwitterSearchPackage.TWITTER_OBJECT_TYPE_DECLARATION__FIELDS);
		}
		return fields;
	}
