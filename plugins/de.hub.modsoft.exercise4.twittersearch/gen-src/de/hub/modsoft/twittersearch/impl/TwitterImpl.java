 ...
 * </p>
 * <ul>
 *   <li>{@link de.hub.modsoft.twittersearch.impl.TwitterImpl#getTypes <em>Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TwitterImpl extends MinimalEObjectImpl.Container implements Twitter {
	...
	public EList<Type> getTypes() {
		if (types == null) {
			types = new EObjectContainmentEList<Type>(Type.class, this, TwitterSearchPackage.TWITTER__TYPES);
		}
		return types;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TwitterSearchPackage.TWITTER__TYPES:
